...
This platform scrapes the weather activity ratings from [Weeronline](weeronline.nl). The ratings for the following activities are included as attributes of a sensor.
- Running
- Walking
- Bicycle
- Barbeque
